  ...
  render: function(){
    ...
    return(
      <div style={{paddingTop: '50px'}}>
        <button onClick={this.toggleShowing} className={showBtnClasses} style={{position: 'absolute', bottom: 50, right: 150}}>Show Current Score</button>
        <div className={classes}>
          <div id='scoreboard' className='container' style={{position: 'relative', zIndex: 999, backgroundColor: 'rgba(133,188,34,.9)', height: 'auto', width: '35%', padding: '25px', color: '#fff', boxShadow: '5px 5px 10px rgba(32,32,32,.25)', textShadow: '3px 3px 5px rgba(32,32,32,.15)'}}>
            ...
            <div className='container' style={{marginTop: '20px'}}>
              <h3>CORE AREAS</h3>
              <div className='container'><hr style={{width: '45%', float: 'left'}}></hr></div>
